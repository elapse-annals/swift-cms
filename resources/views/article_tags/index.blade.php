@extends('article_tags._layout')

@section('content')
    <div class="search">
        @include('article_tags._search')
    </div>
    <div class="stripe">
        @include('article_tags._stripe')
    </div>
    <div class="table">
        @include('article_tags._list')
    </div>
    <div class="page">
        @include('article_tags._page')
    </div>
@endsection
    ...
    <script>
        ...
        var mixin = {
            ...
            methods: {
                ...
                alertThis(article_tag_this) {
                    console.log(article_tag_this)
                },
                deleteRow(id) {
                    axios.delete('/article_tags/' + id)
                        .then(
                            (response) => {
                ...
                reload() {
                    ...
                    axios.get('/article_tags/', {params: request_parameter})
                        .then((response) => {
