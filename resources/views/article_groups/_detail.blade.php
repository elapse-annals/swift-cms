...
<el-row>
    ...
    <el-col :span="16">
        <el-input id="group_name"
                  :class="{aggravation:detail_data.group_name}"
                  v-model="detail_data.group_name"
                  :disabled="is_disabled_edit"
                  placeholder="group_name"></el-input>
    </el-col>
</el-row>
<el-row>
    <el-col :span="4">
    ...
    <el-col :span="16">
        <el-input id="parent_id"
                  :class="{aggravation:detail_data.parent_id}"
                  v-model="detail_data.parent_id"
                  :disabled="is_disabled_edit"
                  placeholder="parent_id"></el-input>
    </el-col>
</el-row>
<el-row>
    <el-col :span="4">
