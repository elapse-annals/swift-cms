@extends('article_groups._layout')

@section('content')
    <div class="search">
        @include('article_groups._search')
    </div>
    <div class="stripe">
        @include('article_groups._stripe')
    </div>
    <div class="table">
        @include('article_groups._list')
    </div>
    <div class="page">
        @include('article_groups._page')
    </div>
@endsection
    ...
    <script>
        ...
        var mixin = {
            ...
            methods: {
                ...
                alertThis(article_group_this) {
                    console.log(article_group_this)
                },
                deleteRow(id) {
                    axios.delete('/article_groups/' + id)
                        .then(
                            (response) => {
                ...
                reload() {
                    ...
                    axios.get('/article_groups/', {params: request_parameter})
                        .then((response) => {
