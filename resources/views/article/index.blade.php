...
@section('content')
    ...
    <div class="stripe">
        @include('article._stripe')
    </div>
    <div class="table">
        @include('article._list')
    </div>
    <div class="page">
        @include('article._page')
    </div>
@endsection
    ...
    <script>
        ...
        var mixin = {
            ...
            methods: {
                ...
                alertThis(article_this) {
                    console.log(article_this)
                },
                deleteRow(id) {
                ...
                reload() {
                    ...
                    axios.get('/articles/', {params: request_parameter})
                        .then((response) => {
